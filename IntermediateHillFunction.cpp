...
int main(){
	...
	string resultsfolder_og = "Data/IntHill_consistent_violator_largeN/" +return_current_time_and_date();
    ...
    std::vector<double> d_a_vals = {0.001,0.005,0.01,0.0005};
    std::vector<double> d_b_vals = {0.01,0.02,0.05158};
