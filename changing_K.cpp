...
int main(){
	...
	string resultsfolder_og = "Data/changing_kx_inthill/" +return_current_time_and_date();
    ...
    std::vector<std::vector<double>> paramgen = {{100},{1}, //lambda beta_x
                                                {1.},{1.}, //gamma beta_y
                                                {1.},{1.}, //alpha beta_z
                                                {0.,5.,-5.},{10.}, //nx Kx
                                                {0.},{20.}, //ny Ky
    ...
    std::vector<double> d_a_vals = {0.1,0.2,0.3};
